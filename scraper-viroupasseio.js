/**
 * Scraper — Virou Passeio Store (Nuvemshop)
 * Roda com: node scraper-viroupasseio.js
 * Teste sem salvar: node scraper-viroupasseio.js --dry-run
 */
...
const BASE_URL = 'https://viroupasseiostore.com'
const FONTE_NOME = 'Virou Passeio Store'
...
async function main() {
  console.log(`🚀 Scraper — Virou Passeio Store${dryRun ? ' (dry-run)' : ''}\n`)
