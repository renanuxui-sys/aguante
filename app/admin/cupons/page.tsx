  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}>
        <h1 style={{ fontSize: 26, fontWeight: 800, letterSpacing: '-0.03em', color: '#1A1A1A', margin: 0 }}>Cupons</h1>
        <p style={{ color: '#8A8880', fontSize: 14, marginTop: 4 }}>Cadastro simples por loja para ativar cupons nos produtos correspondentes.</p>
      </div>
