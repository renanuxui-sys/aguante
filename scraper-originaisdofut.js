/**
 * Scraper — Originais do Fut (Nuvemshop)
 * Roda com: node scraper-originaisdofut.js
 * Teste sem salvar: node scraper-originaisdofut.js --dry-run
 */
...
const BASE_URL = 'https://www.originaisdofut.com'
const FONTE_NOME = 'Originais do Fut'
...
const COLECOES = [
  ...
  { path: '/clubes/internacionais/americas1/', nome: 'América do Sul', categorias: ['Clubes Sulamericanos'], somenteIdentificados: true },
  { path: '/clubes/internacionais/argentinos/', nome: 'Argentinos', categorias: ['Clubes Sulamericanos'], somenteIdentificados: true },
  { path: '/clubes/internacionais/alemaes/', nome: 'Alemães', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/clubes/internacionais/espanhois/', nome: 'Espanhóis', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/clubes/internacionais/franceses/', nome: 'Franceses', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/clubes/internacionais/ingleses/', nome: 'Ingleses', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/clubes/internacionais/italianos/', nome: 'Italianos', categorias: ['Clubes Europeus'], somenteIdentificados: true },
]
...
async function main() {
  console.log(`🚀 Scraper — Originais do Fut${dryRun ? ' (dry-run)' : ''}\n`)
