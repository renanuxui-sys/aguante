/**
 * Scraper — Camisa Doze (Nuvemshop)
 * Roda com: node scraper-camisadoze.js
 * Teste sem salvar: node scraper-camisadoze.js --dry-run
 */
...
const BASE_URL = 'https://www.camisadoze.com'
const FONTE_NOME = 'Camisa Doze'
...
const COLECOES = [
  { path: '/regioes/nacionais/', nome: 'Clubes nacionais', categorias: ['Clubes Brasileiros'] },
  { path: '/regioes/sulamericanas/', nome: 'Times sulamericanos', categorias: ['Clubes Sulamericanos'], somenteIdentificados: true },
  { path: '/regioes/inglaterra/', nome: 'Inglaterra', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/regioes/espanha/', nome: 'Espanha', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/regioes/alemanha/', nome: 'Alemanha', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/regioes/italia/', nome: 'Itália', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/regioes/franca/', nome: 'França', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/regioes/demais-europeus/', nome: 'Demais europeus', categorias: ['Clubes Europeus'], somenteIdentificados: true },
  { path: '/regioes/selecoes1/', nome: 'Seleções', categorias: ['Seleções'] },
]
...
function extrairProdutos($) {
  ...
  $('.js-item-product, [data-component="product-list-item"]').each((_, el) => {
...
async function main() {
  console.log(`🚀 Scraper — Camisa Doze${dryRun ? ' (dry-run)' : ''}\n`)
